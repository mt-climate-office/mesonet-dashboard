...
# Reports page layout
def layout():
    fig_users = px.bar(df_users, x="Day", y="Users", title="Daily User Activity")
    ...
    return html.Div(
        [
            ...
            html.Div(
                [
                    html.Div([dcc.Graph(figure=fig_users)], className="col-md-8"),
                    html.Div(
                        [
            ...
            html.Div(
                [
                    ...
                    html.Button(
                        "Download Sales Data", className="btn btn-primary me-2"
                    ),
